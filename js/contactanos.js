...
function enviarCapcha() {
    ...
    if (capchaUser.value == num3) {
        document.querySelector('#respuestaCapcha').innerHTML = 'Lo contactaremos a la brevedad!';
    } else {
        document.querySelector('#respuestaCapcha').innerHTML = 'Respuesta erronea, por favor intente nuevamente';
        capcha();
    }
}